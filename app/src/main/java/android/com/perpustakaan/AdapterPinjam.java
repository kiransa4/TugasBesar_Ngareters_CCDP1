...
// Buat interface untuk adapter
public interface PinjamAdapter {
    void onBindViewHolder(RecyclerView.ViewHolder holder, int position);
    int getItemCount();
}

// Buat kelas adapter yang implement interface PinjamAdapter
public class PinjamAdapterImpl implements PinjamAdapter {
    private ArrayList<HashMap<String, String>> data;

    public PinjamAdapterImpl(ArrayList<HashMap<String, String>> data) {
        this.data = data;
    }
...
// Buat kelas adapter yang extends RecyclerView.Adapter
public class AdapterPinjam extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private PinjamAdapter adapter;

    public AdapterPinjam(PinjamAdapter adapter) {
