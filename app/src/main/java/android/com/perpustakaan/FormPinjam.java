...
public class FormPinjam extends AppCompatActivity {
    ...
    private static FormPinjam instance;

    private EditText nama_peminjam, id_buku, jumlah_pinjam;
    private Button simpan_pinjam;

    private FormPinjam() {}

    public static FormPinjam getInstance() {
        if (instance == null) {
            instance = new FormPinjam();
        }
        return instance;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        simpan_pinjam = (Button) findViewById(R.id.btn_simpan_pinjam);
    }

    public EditText getNamaPeminjam() {
        return nama_peminjam;
    }

    public EditText getIdBuku() {
        return id_buku;
    }

    public EditText getJumlahPinjam() {
        return jumlah_pinjam;
    }

    public Button getSimpanPinjam() {
