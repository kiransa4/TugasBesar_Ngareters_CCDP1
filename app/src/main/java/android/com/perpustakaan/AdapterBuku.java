...
//        });
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        public class MyHolderFactory {
            public static MyHolder createMyHolder(View itemView) {
        ...
        public class MyHolder extends RecyclerView.ViewHolder {
            ...
            public TextView getTextView() {
                return mView.findViewById(R.id.dt_nama_buku);
            }
        
            public TextView getTextView1() {
                return mView.findViewById(R.id.dt_nama_kategori);
            }
        
            public ImageView getImageView() {
                return mView.findViewById(R.id.img_buku);
            }
        
            public TextView getTextView2() {
                return mView.findViewById(R.id.dt_id_buku);
            }
        
            public TextView getTextView3() {
                return mView.findViewById(R.id.dt_penulis);
            }
        
            public TextView getTextView4() {
                return mView.findViewById(R.id.dt_stok);
            }
        
            public TextView getTextView5() {
                return mView.findViewById(R.id.dt_id_kategori);
            }
        
            public TextView getFilenaeUrl() {
                return mView.findViewById(R.id.dt_filename);
            }
        
            public LinearLayout getLinearBuku() {
                return mView.findViewById(R.id.linier_buku);
            }
        }
