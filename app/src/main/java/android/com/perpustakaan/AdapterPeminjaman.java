...
public class AdapterPeminjaman extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private static AdapterPeminjaman instance;
    private Context context;
    private LayoutInflater inflater;
    private ArrayList<HashMap<String, String>> data;

    private AdapterPeminjaman(Context context, ArrayList<HashMap<String, String>> data) {
        this.context = context;
        inflater = LayoutInflater.from(context);
        this.data = data;
    }

    public static AdapterPeminjaman getInstance(Context context, ArrayList<HashMap<String, String>> data) {
        if (instance == null) {
            instance = new AdapterPeminjaman(context, data);
        }
        return instance;
    }
