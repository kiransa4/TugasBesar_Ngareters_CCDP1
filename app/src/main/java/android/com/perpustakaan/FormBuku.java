...
//                                            return;
    ...
    private void selectImage() {
        ...
        // Buat interface untuk AlertDialog
public interface AlertDialogFactory {
    AlertDialog createAlertDialog(Context context, String message);
}

// Buat kelas yang implementasi interface AlertDialogFactory
public class AlertDialogFactoryImpl implements AlertDialogFactory {
    @Override
...
// Gunakan factory method untuk membuat AlertDialog
AlertDialogFactory factory = new AlertDialogFactoryImpl();
AlertDialog alertDialog = factory.createAlertDialog(this, "Pesan");
alertDialog.show();
